require("dotenv").config({ path: `${process.env.NODE_ENV}.env` || `.env` });
...
const local = {
  ...
  db: {
    name: `${process.env.DB_NAME}-${LOCAL_KEY}`,
...
function _getEnvironment() {
  ...
  if (tEnv == PROD_KEY || tEnv == DEV_KEY || tEnv == TEST_KEY || tEnv == LOCAL_KEY) return tEnv;
  console.log(
